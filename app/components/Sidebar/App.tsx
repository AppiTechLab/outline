          ...
          <SidebarScrollProvider value={scrollArea}>
            ...
            <Section>
              {/* Lists the tag vocabulary as a tree. Provided by plugins/tags;
                  ...
                  Deliberately outside the draggable section list above:
                  reordering is driven by the SidebarSection enum in
                  @shared/types, and adding a member to it would be a further
                  core patch for no real gain. Tags simply sits after the
